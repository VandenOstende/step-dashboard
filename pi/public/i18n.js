...
var T = {
  nl: {
    ...
    language: 'Taal', accent: 'Accentkleur', units: 'Eenheden', power: 'Uitschakelen', tapToWake: 'Tik om te starten', powerFail: 'Niet gelukt — tik om terug te gaan', reboot: 'Herstarten', shutdown: 'Uitschakelen', cancel: 'Annuleren', rebooting: 'Herstarten…', metric: 'Metrisch', imperial: 'Imperiaal', avgUse: 'Ø Verbruik', notifications: 'Meldingen', clear: 'Wissen', noAlerts: 'Geen meldingen — alles in orde.',
    trip: 'Trip A', odo: 'ODO', temps: 'Temp.', kmTotal: 'totaal', range: 'Bereik', charging: 'Opladen', chargeAmp: 'Laadstroom', timeLeft: 'Resterend', gainRate: 'Winst', chargeFull: 'Volledig geladen', tapClose: 'Tik om te sluiten',
  ...
  en: {
    ...
    language: 'Language', accent: 'Accent colour', units: 'Units', power: 'Power off', tapToWake: 'Tap to wake', powerFail: 'Failed — tap to go back', reboot: 'Reboot', shutdown: 'Shutdown', cancel: 'Cancel', rebooting: 'Rebooting…', metric: 'Metric', imperial: 'Imperial', avgUse: 'Ø Use', notifications: 'Notifications', clear: 'Clear', noAlerts: 'No faults — all systems nominal.',
    trip: 'Trip A', odo: 'ODO', temps: 'Temps', kmTotal: 'total', range: 'Range', charging: 'Charging', chargeAmp: 'Charge current', timeLeft: 'Time left', gainRate: 'Gain', chargeFull: 'Fully charged', tapClose: 'Tap to close',
  ...
  fr: {
    ...
    language: 'Langue', accent: 'Couleur d’accent', units: 'Unités', power: 'Éteindre', tapToWake: 'Toucher pour démarrer', powerFail: 'Échec — toucher pour revenir', reboot: 'Redémarrer', shutdown: 'Éteindre', cancel: 'Annuler', rebooting: 'Redémarrage…', metric: 'Métrique', imperial: 'Impérial', avgUse: 'Ø Conso.', notifications: 'Notifications', clear: 'Effacer',
    noAlerts: 'Aucun défaut — tout est normal.',
    trip: 'Trajet A', odo: 'ODO', temps: 'Temp.', kmTotal: 'au total', range: 'Autonomie', charging: 'Charge', chargeAmp: 'Courant de charge', timeLeft: 'Restant', gainRate: 'Gain', chargeFull: 'Charge complète', tapClose: 'Toucher pour fermer',
  ...
  de: {
    ...
    language: 'Sprache', accent: 'Akzentfarbe', units: 'Einheiten', power: 'Ausschalten', tapToWake: 'Tippen zum Starten', powerFail: 'Fehlgeschlagen — tippen zum Zurückkehren', reboot: 'Neustart', shutdown: 'Ausschalten', cancel: 'Abbrechen', rebooting: 'Neustart…', metric: 'Metrisch', imperial: 'Imperial', avgUse: 'Ø Verbrauch', notifications: 'Meldungen', clear: 'Löschen',
    noAlerts: 'Keine Fehler — alles in Ordnung.',
    trip: 'Trip A', odo: 'ODO', temps: 'Temp.', kmTotal: 'gesamt', range: 'Reichweite', charging: 'Laden', chargeAmp: 'Ladestrom', timeLeft: 'Restzeit', gainRate: 'Zuwachs', chargeFull: 'Voll geladen', tapClose: 'Tippen zum Schließen',
