 ...
 *
 * Het paneel zet de UI in een 480 × 320-frame — dezelfde maat als het schermpje
 * op het stuur — met de schuiven ernaast. Sla `public/index.html` op en het
 * frame herlaadt zichzelf.
 *
...
const server = http.createServer(async (req, res) => {
  ...
  if (p === "/settings" && m === "GET") {
    return send(res, 200, {
      theme: S.theme, tempWarn: 70, tempCrit: 90, packWh: 1147, whPerKm: 18,
      speedMax: 35, bright: 80, start: 0, topSpeed: 41.2, pollMs: 150
    });
  }
